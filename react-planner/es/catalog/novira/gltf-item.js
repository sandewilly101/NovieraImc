...
var gltfItemBase = {
  ...
  render2D: function render2D(element) {
    ...
    return React.createElement(
      ...
      React.createElement('rect', { x: '0', y: '0', width: w, height: d, style: { stroke: stroke, strokeWidth: 2, fill: 'rgba(124,58,237,0.15)' } })
    );
  },
    ...
    return new Promise(function (resolve) {
      loader.load(url, function (gltf) {
        try {
          ...
          if (element.selected) {
            var helper = new BoxHelper(root, SharedStyle.MESH_SELECTED);
