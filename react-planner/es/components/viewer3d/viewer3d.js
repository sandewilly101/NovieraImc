...
var Scene3DViewer = function (_React$Component) {
  ...
  function Scene3DViewer(props) {
    ...
    _this.canvasWrapperRef = React.createRef();
  ...
  _createClass(Scene3DViewer, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (this.props.state.scene !== prevProps.state.scene) {
        ...
        updateScene(this.planData, this.props.state.scene, prevProps.state.scene, changedValues.toJS(), actions, this.context.catalog);
      }
    ...
    value: function render() {
      return React.createElement('div', { ref: this.canvasWrapperRef });
    }
  }]);
