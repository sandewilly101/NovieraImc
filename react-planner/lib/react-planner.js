  ...
  _createClass(ReactPlanner, [{
    ...
    value: function componentDidUpdate() {
      var _props2 = this.props,
          ...
          state = _props2.state,
          projectActions = _props2.projectActions,
          catalog = _props2.catalog;
...
/* react-redux v6+ — store comes from ReactReduxContext, not legacy contextTypes */
ReactPlanner.contextType = _reactRedux.ReactReduxContext;
