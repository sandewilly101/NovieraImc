...
exports.replaceNoviraPlannerState = replaceNoviraPlannerState;
...
function replaceNoviraPlannerState(nextPlannerState) {
  return {
    type: _constants.NOVIRA_REPLACE_PLANNER_STATE,
