...
var Scene3DViewer = function (_React$Component) {
  ...
  function Scene3DViewer(props) {
    ...
    _this.canvasWrapperRef = _react2.default.createRef();
  ...
  _createClass(Scene3DViewer, [{
    ...
    value: function componentDidMount() {
      ...
      // RENDERER: cap devicePixelRatio for GPU cost on HiDPI screens
    ...
    value: function componentWillUnmount() {
      ...
      if (this.orbitControls && typeof this.orbitControls.dispose === 'function') {
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (this.props.state.scene !== prevProps.state.scene) {
        var changedValues = (0, _immutablediff2.default)(prevProps.state.scene, this.props.state.scene);
        (0, _sceneCreator.updateScene)(this.planData, this.props.state.scene, prevProps.state.scene, changedValues.toJS(), actions, this.context.catalog);
      }
    ...
    value: function render() {
      return _react2.default.createElement('div', { ref: this.canvasWrapperRef });
    }
  }]);
